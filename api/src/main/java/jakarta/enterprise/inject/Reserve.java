 ...
 *
 * <p>
 * During typesafe resolution, other, non-reserve beans take precedence over reserves.
 * </p>
 *
 * <p>
 * A reserve is not available for injection, lookup or name resolution in a module unless the module
 * is a bean archive and the reserve is <em>selected</em> for the application (by adding the {@link Priority}
 * annotation).
 * </p>
 *
 * <p>
