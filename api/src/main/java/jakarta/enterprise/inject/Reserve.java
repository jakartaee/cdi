 ...
 * is a bean archive and the reserve is explicitly <em>selected</em> for the application (by adding
 * the {@link Priority} annotation). A reserve is never available for injection, lookup
