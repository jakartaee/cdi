 ...
 * or {@linkplain #isStandby() standbys}, or have {@linkplain #isNamed() default names}.
 *
 * @since 4.0
 */
public interface StereotypeInfo {
    ...
    /**
     * Returns whether this stereotype is meta-annotated {@link jakarta.enterprise.inject.Standby @Standby}.
     * This means that all beans with this stereotype are standbys.
     *
     * @return whether this stereotype is meta-annotated {@link jakarta.enterprise.inject.Standby @Standby}
     */
    boolean isStandby();
