 ...
 * exists and call it. The CDI container can assume that the {@link #create(SyntheticInjections, Parameters)}
...
public interface SyntheticBeanCreator<T> {
     ...
     * All {@code @Dependent} bean instances obtained from {@code SyntheticInjections} during execution
     * remain managed until the synthetic bean instance is destroyed. Therefore, implementations
     * are encouraged to destroy unneeded {@code @Dependent} bean instances obtained from {@code SyntheticInjections}.
     * <p>
