...
/**
 * <p>
 * The container fires an event of this type for each {@linkplain Observes observer method} of each
...
public interface ProcessObserverMethod<T, X> {
    ...
    /**
     * The {@link ObserverMethod} object that will be used by the container to invoke the observer
     * when a matching event is fired.
     *
     * @return the {@link ObserverMethod} object that will be used by the container to call the
     *         observer method
     * @throws IllegalStateException if called outside of the observer method invocation
     */
    ...
    /**
     * Replaces the {@link ObserverMethod}.
     *
     * @param observerMethod the new {@link ObserverMethod} object to use
     * @throws IllegalStateException if called outside of the observer method invocation
     *
     * @since 2.0
     */
