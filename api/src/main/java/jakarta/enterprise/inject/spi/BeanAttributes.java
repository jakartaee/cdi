...
public interface BeanAttributes<T> {
    ...
    /**
     * Determines if the bean is {@linkplain jakarta.enterprise.context.AutoClose automatically closed}.
     *
     * @return <code>true</code> if the bean is {@linkplain jakarta.enterprise.context.AutoClose automatically closed},
     *         and <code>false</code> otherwise.
     * @since 5.0
     */
