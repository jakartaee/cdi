...
import jakarta.enterprise.inject.Standby;
...
public interface BeanAttributes<T> {
    ...
    /**
     * Determines if the bean is a {@linkplain Standby standby}.
     *
     * A custom implementation of {@link Bean} may implement {@link Prioritized} in order to be selected for the application.
     * {@link Prioritized#getPriority()} determines the priority used to resolve ambiguities.
     *
     * @return <code>true</code> if the bean is a {@linkplain Standby standby}, and <code>false</code>
     *         otherwise.
     */
    public default boolean isStandby() {
        // avoid breaking older `Bean` implementations
        return false;
    }
