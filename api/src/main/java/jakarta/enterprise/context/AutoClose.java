...
/**
 * Marks the annotated bean as automatically closed. May be applied to a bean class,
 * producer method or field or {@linkplain jakarta.enterprise.inject.Stereotype stereotype}.
 * <p>
 * Automatically closed beans may implement the {@link AutoCloseable} interface. If they do,
