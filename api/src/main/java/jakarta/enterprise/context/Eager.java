 ...
 * <p>
 * Eagerly initialized bean is equivalent to a bean that declares an observer method
 * of the {@link jakarta.enterprise.event.Startup Startup} event.
 *
 * @since 5.0
 */
...
public @interface Eager {
    /**
     * Supports inline instantiation of {@link Eager}.
     *
     * @since 5.0
     */
