 ...
 * that a request context should be started when this method is invoked.
 *
 * The request context will be started before the method is called, and stopped when the method invocation is
