 ...
 * @since 2.0
 */
public interface AnnotatedTypeConfiguratorOld<T> {
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToType(Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromType(Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromType(Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToField(Field field, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToField(AnnotatedField<? super T> field, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromField(Field field, Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromField(AnnotatedField<? super T> field,
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToMethod(Method method, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToMethod(AnnotatedMethod<? super T> method, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromMethod(Method method, Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromMethod(AnnotatedMethod<? super T> method,
                                                  Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToMethodParameter(Method method, int position, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromMethodParameter(Method method,
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToConstructor(Constructor<T> constructor, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToConstructor(AnnotatedConstructor<T> constructor, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromConstructor(Constructor<T> constructor,
                                                       Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromConstructor(AnnotatedConstructor<T> constructor,
                                                       Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToConstructorParameter(Constructor<T> constructor,
                                                           int position,
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromConstructorParameter(Constructor<T> constructor,
                                                                int position,
                                                                Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromParameter(AnnotatedParameter<? super T> parameter,
                                                     Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> addToParameter(AnnotatedParameter<? super T> parameter, Annotation annotation);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromAll(Class<? extends Annotation> annotationType);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> removeFromAll(Annotation annotation);
     ...
     * @return self
     */
    <U extends T> AnnotatedTypeConfiguratorOld<T> read(AnnotatedType<U> type);
     ...
     * @return self
     */
    <U extends T> AnnotatedTypeConfiguratorOld<T> read(AnnotatedType<U> type, boolean overwrite);
     ...
     * @return self
     */
    <U extends T> AnnotatedTypeConfiguratorOld<T> read(Class<U> type);
     ...
     * @return self
     */
    <U extends T> AnnotatedTypeConfiguratorOld<T> read(Class<U> type, boolean overwrite);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> overrideFieldType(Field field, Type type);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> overrideFieldType(AnnotatedField<? super T> field, Type type);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> overrideMethodParameterType(Method method, int position, Type type);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> overrideConstructorParameterType(Constructor<T> constructor, int position, Type type);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> overrideParameterType(AnnotatedParameter<? super T> parameter, Type type);
     ...
     * @return self
     */
    AnnotatedTypeConfiguratorOld<T> setType(Class<T> type);
}
