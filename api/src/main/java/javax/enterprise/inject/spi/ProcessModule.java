 ...
 * values of these collections is determined by reading the <literal>beans.xml</literal> file of the bean deployment archive.
 * </p>
 * <p>
...
public interface ProcessModule {
    ...
    /**
     * @return an iterator over <literal>AnnotatedType</literal> objects representing the Java classes and interfaces in the
     *         bean archive
     */
