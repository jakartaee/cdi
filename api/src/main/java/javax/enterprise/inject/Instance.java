...
public interface Instance<T> extends Iterable<T>, Provider<T> {
    ...
    /**
     * Returns the metadata about the unique bean that matches the required type and required qualifiers and is eligible for
     * injection into the class into which the parent <tt>Instance</tt> was injected, or throws an
