...
public abstract class AbstractAnnotatedTest {
    ...
    @Test public void shouldFindAnnotationsOnAmmptated() {
    ...
    @Test public void shouldReturnSingletonForNonRepeatableAnnotation() {
        ...
        Set<Repeaters> repeaterses = annotated.getAnnotations(Repeaters.class);

        Assert.assertEquals(repeaterses, Collections.singleton(getAnnotation(Repeaters.class)));
    }
