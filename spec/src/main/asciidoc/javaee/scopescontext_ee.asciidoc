...
* As defined by the Jakarta Enterprise Bean specification, an Jakarta Enterprise Bean stateful session beans is passivation capable if:
...
* As defined by the Jakarta Enterprise Bean specification, an Jakarta Enterprise Bean stateless session bean or an Jakarta Enterprise Bean singleton session bean is not passivation capable.
...
* during any remote method invocation of any Jakarta Enterprise Bean, during any asynchronous method invocation of any Jakarta Enterprise Bean, during any call to an Jakarta Enterprise Bean timeout method and during message delivery to any Jakarta Enterprise Bean message-driven bean.
...
The application context is shared between all servlet requests, web service invocations, asynchronous invocation of an event observer, Jakarta Enterprise Bean remote method invocations, Jakarta Enterprise Bean asynchronous method invocations, Jakarta Enterprise Bean timeouts and message deliveries to message-driven beans that execute within the same application.
