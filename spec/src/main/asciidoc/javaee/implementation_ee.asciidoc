...
If the resulting set of bean types for a session bean contains <<legal_bean_types,non-legal bean types>>, these types are removed from the set of bean types.
...
If the resulting set of bean types for a resource contains <<legal_bean_types,non-legal bean types>>, these types are removed from the set of bean types.
