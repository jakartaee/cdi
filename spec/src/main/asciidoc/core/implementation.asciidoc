...
If the resulting set of bean types for a managed bean contains <<legal_bean_types,non-legal bean types>>, these types are removed from the set of bean types.
...
If the resulting set of bean types for a producer method contains <<legal_bean_types,non-legal bean types>>, these types are removed from the set of bean types.
...
If the resulting set of bean types for a producer field contains <<legal_bean_types,non-legal bean types>>, these types are removed from the set of bean types.
