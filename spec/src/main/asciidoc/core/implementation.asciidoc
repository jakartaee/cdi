...
The unrestricted set of bean types for a managed bean contains the bean class, every superclass type and all superinterface types it implements directly or indirectly.
...
* If the return type is a class, the unrestricted set of bean types contains the return type, every superclass type and all superinterface types it implements directly or indirectly.
...
* If the field type is a class, the unrestricted set of bean types contains the field type, every superclass type and all superinterface types it implements directly or indirectly.
