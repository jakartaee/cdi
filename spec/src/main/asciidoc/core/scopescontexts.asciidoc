...
An eagerly initialized bean is treated as if it declared an empty non-static synchronous observer method with:

- observed event type of `Startup`,
- no observed event qualifier,
- priority of `Integer.MIN_VALUE`.
