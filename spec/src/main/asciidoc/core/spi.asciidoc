...
With `AnnotatedTypeConfigurator` you can perform the following operations:
...
* `AnnotatedType` built with `javax.enterprise.inject.spi.builder.AnnotatedTypeBuilder`,
