...
* `javax.enterprise.inject.spi.builder.AnnotatedFieldConfigurator` (defined in <<annotated_field_configurator>>) to configure an `AnnotatedField`
* `javax.enterprise.inject.spi.builder.AnnotatedConstructorConfigurator` (defined in <<annotated_constructor_configurator>>) to configure an `AnnotatedConstructor`
* `javax.enterprise.inject.spi.builder.AnnotatedMethodConfigurator` (defined in <<annotated_method_configurator>>) to configure an `AnnotatedMethod`
* `javax.enterprise.inject.spi.builder.AnnotatedParameterConfigurator` (defined in <<annotated_parameter_configurator>>) to configure an `AnnotatedParameter`
...
`AnnotatedMethodConfigurator` is obtained through `AnnotatedTypeConfigurator` as defined in <<AnnotatedTypeConfigurator>>
...
`AnnotatedConstructorConfigurator` is obtained through `AnnotatedTypeConfigurator` as defined in <<AnnotatedTypeConfigurator>>
...
`AnnotatedFieldConfigurator` is obtained through `AnnotatedTypeConfigurator` as defined in <<AnnotatedTypeConfigurator>>:
