...
* a class `T` exists which declares a producer field or producer method which is annotated with `@Alternative` or an <<alternative_stereotype,@Alternative @Stereotype>> , or
