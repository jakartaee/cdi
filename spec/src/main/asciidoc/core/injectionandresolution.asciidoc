...
A reserve is not available for injection, lookup or name resolution to classes in a module unless the module is a bean archive and the reserve is explicitly _selected_ for the application.
