...
* the bean is enabled,
* the bean is either not an alternative, or the module is a bean archive and the bean is a selected alternative for the bean archive, or the bean is a selected alternative for the application, and
