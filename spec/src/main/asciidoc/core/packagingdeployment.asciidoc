...
* Which alternatives, standbys and interceptors are _enabled_
...
* determine which alternatives, standbys and interceptors are enabled, according to the rules defined in <<enablement>>.
