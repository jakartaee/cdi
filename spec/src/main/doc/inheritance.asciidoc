...
Suppose a class X is extended directly or indirectly by the bean class of a bean Y.
...
Suppose a class X is extended directly or indirectly by the bean class of a managed bean or bean Y.
