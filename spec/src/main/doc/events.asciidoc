...
[source, java]
----
public void afterLogin(@Observes @Priority(APPLICATION) LoggedInEvent event) { ... }
----
...
[source, java]
----
public void afterLogin(@Observes @Priority(APPLICATION) @Admin LoggedInEvent event) { ... }
----
...
[source, java]
----
public void afterLogin(@Observes @Priority(APPLICATION) LoggedInEvent event, @Manager User user, Logger log) { ... }
----
...
[source, java]
----
public void afterLogin(@Observes @Priority(APPLICATION) LoggedInEvent event, EventMetadata metadata) { ... }
----
...
[source, java]
----
public void refreshOnDocumentUpdate(@Observes(receive=IF_EXISTS) @Priority(APPLICATION) @Updated Document doc) { ... }
----
...
[source, java]
----
void onDocumentUpdate(@Observes(during=AFTER_SUCCESS) @Priority(APPLICATION) @Updated Document doc) { ... }
----

[[observer_notification]]

=== Observer notification and ordering
...
* honor the priority if it is defined using the +@Priority+ annotation
...
By default, the order in which observer methods are called is not defined. The +@Priority+ annotation can be applied to observer methods to specify a priority. Observers with the smaller priority values are called first. The order of more than one observer with the same priority is undefined.
