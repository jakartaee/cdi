...
When running in Java EE the container is required to implement request context with the following rules.
...
When running in Java EE the container is required to implement application context with the following rules.
