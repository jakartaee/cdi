...
Any scope type is a bean defining annotation, and any bean which has a scope type declared on the bean class is said to have a bean defining annotation. For example, this dependent scoped bean has a bean defining annotation:
