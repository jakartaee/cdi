...
Any EJB component-defining annotation is a bean defining annotation. Any bean which has an EJB component defining annotation is said to have a bean defining annotation. For example this dependent scoped bean has a bean defining annotation:
