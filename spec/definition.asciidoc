...
Any scope type is a bean defining annotation, and any bean which has scope type is said to have a bean defining annotation. For example, this dependent scoped bean has a bean defining annotation:
