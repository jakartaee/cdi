...
For each Java class, interface or enum deployed in a bean archive, the container discovers the type only if there is no active exclude filter for which:

* the fully qualified name of the class name matches the value of the name attribute of the exclude filter, or
* the package name of the class name matches the value of the name attribute with a suffix ".\*" of the exclude filter, or
* the package name of the class name starts with the value of the name attribute with a suffix ".\*\*" of the exclude filter.

Consider the follow +beans.xml+ file:
...
<beans xmlns="http://java.sun.com/xml/ns/javaee" 
    ...
    <scan>
        ...
        <exclude name="com.acme.ejb.**">
            ...
            <weld:if-system-property name="exclude-ejbs"/>
        </exclude>
    </scan>
...
For each discovered type, the container must:
